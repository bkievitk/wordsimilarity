...
public class MainGUIInternal extends MainGUI {
	...
	// Frames.
	public JInternalFrame wizardFrame = new JInternalFrame("Wizard", true, true, true, true);
	public JInternalFrame wordFrame = new JInternalFrame("Word", true, true, true, true);
	public JInternalFrame renderingProgress = new JInternalFrame("Rendering Progress", true, true, true, true);
	public JInternalFrame networkTools = new JInternalFrame("Network Tools", true, true, true, true);
	public JInternalFrame showOptions = new JInternalFrame("Options", true, true, true, true);
	public JInternalFrame mainFrame = new JInternalFrame("main", true, true, true, true);
	public JInternalFrame tutorial = new JInternalFrame("tutorial", true, true, true, true);
	...
	public MainGUIInternal(boolean startSetup) {	
		...
		desktop.add(wizardFrame);
		desktop.add(wordFrame);
		desktop.add(renderingProgress);
		desktop.add(networkTools);
		desktop.add(showOptions);
		desktop.add(mainFrame);
		desktop.add(tutorial);
